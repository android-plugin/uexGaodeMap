...
public class CustomBubbleMarkerLayout implements AMap.InfoWindowAdapter {
	...
	public View getInfoWindow(Marker marker) {
		View infoWindow = ((Activity) mContext).getLayoutInflater().inflate(EUExUtil.getResLayoutID("plugin_uexgaodemap_custom_info_window"), null);
		infoWindow.setLayoutParams(new ViewGroup.LayoutParams(mData.getWidth(), ViewGroup.LayoutParams.WRAP_CONTENT));
	...
	public void render(Marker marker, View view) {
		LinearLayout bg = (LinearLayout) view.findViewById(EUExUtil.getResIdID("plugin_uexgaodemap_custom_info_bg"));
		try {
		...
		TextView titleUi = ((TextView) view.findViewById(EUExUtil.getResIdID("plugin_uexgaodemap_title")));
		if (title != null) {
		...
		TextView snippetUi = ((TextView) view.findViewById(EUExUtil.getResIdID("plugin_uexgaodemap_snippet")));
		if (snippet != null) {
